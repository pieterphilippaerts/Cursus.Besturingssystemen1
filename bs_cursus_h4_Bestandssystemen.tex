...
descriptor}.\index{bestandsbeschrijving (file descriptor)}
...
(\emph{flat directory}\index{directory!flat}). Hierbij worden de
...
directory}\index{directory!working}) genoemd. Hierdoor moet niet telkens het
...
plaatsverlies aan \emph{interne fragmentatie}\index{fragmentatie!intern} kleiner
...
Het FAT-bestandssysteem\index{bestandssysteem!FAT} is het oorspronkelijke bestandssysteem van
...
NTFS\index{bestandssysteem!NTFS} staat voor New Technology File System. Het is het standaard
...
extents, die in de context van NTFS vaak data runs\index{data run} of streams\index{stream} genoemd
...
wordt het \emph{Extended File System}\index{bestandssysteem!extended file system} vaak beschouwd als het standaard-bestandssysteem
