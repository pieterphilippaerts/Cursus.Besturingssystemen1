...
men hiervoor het concept van het \emph{pad}\index{pad}: de
...
Het heeft geen specifieke functie in het bestandssysteem, en het is altijd . Het \emph{superblok}\index{superblok} bevat globale
...
bekijken.\index{inode} Linux is geschreven in C, en de inode struct\footnote{Een struct in C kan je vergelijken
