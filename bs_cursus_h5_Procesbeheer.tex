...
Naast de niet-pre\"emptieve strategie\"en die in de vorige sectie besproken werden, bestaan er natuurlijk ook pre\"emptieve algoritmes. Hier zal het besturingssysteem de controle van de processor kunnen terugeisen, ook al is het actieve programma nog niet klaar. In het schema van de toestanden van een proces, is er hier dus w\'el een overgang van `actief' naar `gereed'. 
